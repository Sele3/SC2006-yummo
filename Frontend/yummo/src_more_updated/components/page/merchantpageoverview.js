...
else date2 = today.getDate() + "-" + 12 + "-" + (today.getFullYear() - 1);
...
function GetReservations() {
  ...
  async function getreservations() {
    ...
    axios
      .get(
        "http://127.0.0.1:8000/api/restaurants/" + restId + "/reservations",
        {
          headers: {
...
function GetReviews() {
  ...
  async function getreviews() {
    axios
      .get("http://127.0.0.1:8000/api/restaurants/" + restId + "/reviews")
      .then((response) => {
